from loja.admin.rotas import categorias
    ...
    if request.method == "POST":
        ...
        if request.files.get('image_1'):
            try:
                ...
                produto.image_1 = photos.save(request.files.get(
                    'image_1'), name=secrets.token_hex(10)+".")
            except:
                produto.image_1 = photos.save(request.files.get(
                    'image_1'), name=secrets.token_hex(10)+".")
        ...
        if request.files.get('image_2'):
            try:
                ...
                produto.image_2 = photos.save(request.files.get(
                    'image_2'), name=secrets.token_hex(10)+".")
            except:
                produto.image_2 = photos.save(request.files.get(
                    'image_2'), name=secrets.token_hex(10)+".")
        ...
        if request.files.get('image_3'):
            try:
                ...
                produto.image_3 = photos.save(request.files.get(
                    'image_3'), name=secrets.token_hex(10)+".")
            except:
                produto.image_3 = photos.save(request.files.get(
                    'image_3'), name=secrets.token_hex(10)+".")
